...
describe('config testing set', () => {
  ...
  it('assigns correct data-id to single child', async () => {
    ...
    await waitFor(() => {
      expect(testDiv).toHaveAttribute('data-eid', 'div:1-div:1');
    });
  });
  ...
  it('assign correct data-id to multiple children', async () => {
    ...
    await waitFor(() => {
      expect(testDiv1).toHaveAttribute('data-eid', 'div:1-div:1');
      expect(testDiv2).toHaveAttribute('data-eid', 'div:1-div:2');
    });
  });
});
